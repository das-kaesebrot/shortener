    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        // self management
                        .requestMatchers(HttpMethod.GET, "/api/v1/auth/me").access(hasScope("self"))
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/auth/me").access(hasScope("self"))
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/auth/me").access(hasScope("self"))
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/logout", "/api/v1/auth/revoke").access(hasScope("self"))
                        // admin management
                        .requestMatchers(HttpMethod.GET, "/api/v1/auth/users/*").access(hasScope("users_read"))
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/auth/users/*").access(hasScope("users_write"))
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/auth/users/*").access(hasScope("users_delete"))
                        //
                        // --- LINKS controller ---
                        //
